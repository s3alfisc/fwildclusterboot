...
test_that("test that boottest.fixest runs properly, independent of how input looks"){
  ...
  voters <- fabricatr::fabricate(
   ...
   expect_equal(boot_feols_fit_1$p_val, boot_feols_fit_2$p_val)
   expect_equal(boot_feols_fit_2$p_val, boot_feols_fit_3$p_val)
   
   # test confidence sets for equivalence
   expect_equal(boot_feols_fit_1$conf_int, boot_feols_fit_2$conf_int)
   expect_equal(boot_feols_fit_2$conf_int, boot_feols_fit_3$conf_int)
   
   # test t-stats for equivalence
   expect_equal(boot_feols_fit_1$t_stat, boot_feols_fit_2$t_stat)
   expect_equal(boot_feols_fit_2$t_stat, boot_feols_fit_3$t_stat)
