...
seed <- 1234
set.seed(seed)
voters <- create_data_2(N = 10000, N_G1 = 30, icc1 = 0.01, N_G2 = 20, icc2 = 0.01, numb_fe1 = 40, numb_fe2 = 10, seed = seed)
B <- 50000
...
time_3 <- plot_bench_twoway_1$stats[1, ]

bench <- 
data.frame(experiment = c(rep("Experiment 1", 4), rep("Experiment 2", 4), rep("Experiment 3", 2)),
           time = c(time_1, time_2, time_3), 
           #N_G = c(rep(20, 4), rep(60, 4)), 
           #N = rep(10000, 8), 
           #B = rep(10000, 8), 
           est = c(rep(c("sandwich", 
                       "sandwich, 2 clust", 
                       "sandwich, 4 clust", 
                       "boottest"), 2), "sandwich, 4 clust", 
                       "boottest"))
