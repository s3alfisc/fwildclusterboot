...
expect_equal(boot_lm$conf_int, boot_fixest$conf_int)
expect_equal(boot_fixest$conf_int, boot_felm$conf_int, tolerance = 1e-2)
expect_equal(boot_felm$conf_int, boot_fixest_c$conf_int, tolerance = 1e-2)
expect_equal(boot_fixest_c$conf_int, boot_felm_c$conf_int, tolerance = 1e-2)
expect_equal(boot_felm_c$conf_int, boot_lm$conf_int, tolerance = 1e-2)
...
# 
# # confidence intervals
# expect_equal(boot_lm$conf_int, boot_fixest$conf_int, tolerance = 1e-2)
# expect_equal(boot_fixest$conf_int, boot_felm$conf_int, tolerance = 1e-2)
# expect_equal(boot_felm$conf_int, boot_fixest_c$conf_int, tolerance = 1e-2)
# expect_equal(boot_fixest_c$conf_int, boot_felm_c$conf_int, tolerance = 1e-2)
# expect_equal(boot_felm_c$conf_int, boot_lm$conf_int, tolerance = 1e-2)
