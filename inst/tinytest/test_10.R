...
# 
# 
# feols_fit <- feols(proposition_vote ~ treatment + ideology1 + log_income + Q1_immigration, data = create_data_2(N = 1000, N_G1 = 10, icc1 = 0.91, N_G2 = 10, icc2 = 0.51, numb_fe1 = 10, numb_fe2 = 10, seed = 12345))
# #felm_fit <- felm(proposition_vote ~ treatment + ideology1 + log_income + Q1_immigration | 0 | 0 , data = create_data_2(N = 1000, N_G1 = 10, icc1 = 0.91, N_G2 = 10, icc2 = 0.51, numb_fe1 = 10, numb_fe2 = 10, seed = 12345))
# lm_fit <- lm(proposition_vote ~ treatment + ideology1 + log_income + Q1_immigration, data = create_data_2(N = 1000, N_G1 = 10, icc1 = 0.91, N_G2 = 10, icc2 = 0.51, numb_fe1 = 10, numb_fe2 = 10, seed = 12345))
# 
...
# 
# B <- 1000
# res_fixest <- suppressWarnings(fwildclusterboot::boot_algo.multclust(preprocess_fixest, B = B,
#                                                     wild_draw_fun = function(n){sample(c(-1,1), n, replace = TRUE)}))
# #res_felm <- fwildclusterboot::boot_algo.multclust(preprocess_felm, B = B)
# res_lm <- suppressWarnings(fwildclusterboot::boot_algo.multclust(preprocess_lm, B = B, 
#                                                 wild_draw_fun = function(n){sample(c(-1,1), n, replace = TRUE)}))
# 
# res_fixest2 <- suppressWarnings(fwildclusterboot::boot_algo2.multclust(preprocess_fixest, boot_iter = B,
#                                                       wild_draw_fun = function(n){sample(c(-1,1), n, replace = TRUE)}))
# #res_felm2 <- fwildclusterboot::boot_algo2.multclust(preprocess_felm, boot_iter = B)
# res_lm2 <- suppressWarnings(fwildclusterboot::boot_algo2.multclust(preprocess_lm, boot_iter = B,
#                                                   wild_draw_fun = function(n){sample(c(-1,1), n, replace = TRUE)}))
# 
...
# 
# res_p_val_fixest <- fwildclusterboot::invert_p_val.algo_multclust(object = res_fixest,
...
# res_p_val_fixest2 <- fwildclusterboot::invert_p_val2.algo_multclust(object = res_fixest2,
#                                                  point_estimate = point_estimate,
#                                                  se_guess = se_guess, 
#                                                  clustid = preprocess_fixest$clustid, 
#                                                  alpha = preprocess_fixest$alpha, 
...
# res_p_val_lm <- fwildclusterboot::invert_p_val.algo_multclust(object = res_lm,
#                                 point_estimate = point_estimate,
#                                 se_guess = se_guess, 
...
# res_p_val_lm2 <- fwildclusterboot::invert_p_val2.algo_multclust(object = res_lm2,
#                                                point_estimate = point_estimate,
#                                                se_guess = se_guess, 
#                                                clustid = preprocess_fixest$clustid, 
#                                                alpha = preprocess_fixest$alpha, 
