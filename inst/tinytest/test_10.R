...
# 
# B <- 10000
# res_fixest <- fwildclusterboot::boot_algo.multclust(preprocess_fixest, boot_iter = B, wild_draw_fun = wild_draw_fun)
# #res_felm <- fwildclusterboot::boot_algo.multclust(preprocess_felm, B = B)
# res_lm <- fwildclusterboot::boot_algo.multclust(preprocess_lm, boot_iter = B, wild_draw_fun = wild_draw_fun)
# 
# res_fixest2 <- fwildclusterboot::boot_algo2.multclust(preprocess_fixest, boot_iter = B, wild_draw_fun = wild_draw_fun)
# #res_felm2 <- fwildclusterboot::boot_algo2.multclust(preprocess_felm, boot_iter = B)
# res_lm2 <- fwildclusterboot::boot_algo2.multclust(preprocess_lm, boot_iter = B, wild_draw_fun = wild_draw_fun)
# 
