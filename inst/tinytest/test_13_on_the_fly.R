...
# library(data.table)
# 
# voters <- fwildclusterboot:::create_data_2(N = 10000, N_G1 = 20, icc1 = 0.91, N_G2 = 10, icc2 = 0.51, numb_fe1 = 10, numb_fe2 = 10, seed = 12345)
...
# # feols_fit <- feols(proposition_vote ~ treatment + ideology1 + log_income, cluster =  c("group_id1", "group_id2"),  fixef =  "Q1_immigration", data = voters)
...
# feols_fit <- feols(proposition_vote ~ treatment + ideology1 + log_income, cluster = "group_id1",fixef =  "Q1_immigration", data = voters)
...
# feols_fit <- feols(proposition_vote ~ treatment + ideology1 + log_income, cluster = c("group_id1"),fixef =  "Q1_immigration", data = voters)
# felm_fit <- felm(proposition_vote ~ treatment + ideology1 + log_income | Q1_immigration | 0 |group_id1 , data = voters)
# 
# res <- boottest(feols_fit, param = "treatment", B = 1000, clustid = c("group_id1", "group_id2"))
