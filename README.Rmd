...
# setwd("C:/Users/alexa/Dropbox/fwildclusterboot")
# usethis::use_rcpp_eigen()
# compileAttributes("C:/Users/alexa/Dropbox/fwildclusterboot")
...
* Experiment 3: N = 10000, B = 10000, two closters with N_G1 = 20 and N_G2 = 20, N_G = 400
...
seed <- 1234
set.seed(seed)
voters <- create_data_2(N = 10000, N_G1 = 20, icc1 = 0.01, N_G2 = 20, icc2 = 0.01, numb_fe1 = 40, numb_fe2 = 10, seed = seed)
B <- 10000
...
#                        "boottest"))
# 
# bench$est <- factor(bench$est, levels = c("sandwich", 
#                                         "sandwich, 2 clust", 
#                                         "sandwich, 4 clust", 
#                                         "boottest"))
# 
