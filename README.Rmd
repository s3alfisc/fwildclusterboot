...
The `boottest` always calculates p-values for a given univariate hypothesis test.
...
Results of timing benchmarks of `fwildclusterboot` with `multiwayvcic` with
- N = 10000 observations
- b = 10000 bootstrap iterations
- n_g = 40 clusters
and 4 cores for the parallel option.
