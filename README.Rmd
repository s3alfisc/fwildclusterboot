...
Via the [JuliaConnectoR](https://github.com/stefan-m-lenz/JuliaConnectoR), `{fwildclusterboot}` further ports functionality of [WildBootTests.jl](https://github.com/droodman/WildBootTests.jl) - which provides a very fast implementation of the wild cluster bootstrap for OLS, IV, and tests of multiple joint hypotheses - to R.
