...
# 2) bootest based on object of class feols
 boot_fixest = boottest(feols_fit, clustid = c("group_id1"), B = B, seed = seed, param = "treatment", conf_int = FALSE)
 boot_fixest1 = boottest(feols_fit1, clustid = c("group_id1"), B = B, seed = seed, param = "treatment", conf_int = FALSE, beta = 0)
