...
//   Function f = pkg["runif"];
//   return(f(Named("n") = 1));
// }
// 
// // [[Rcpp::export]]
// NumericMatrix v_enumerated(int N_G_bootcluster){
// 
//   Environment pkg = Environment::namespace_env("gtools");
// 
//   Function f = pkg["permutations"];
// 
//   NumericVector s(2);
...
//   s[1] = -1;
// 
//   return( f( Named("n") =  2, Named("r")=N_G_bootcluster, Named("v") =s,
// Named("repeats.allowed") = TRUE) );
// 
// }
