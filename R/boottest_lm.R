boottest.lm <- function(object, 
  ...
  #'boot3 <- boottest(lm_fit, B = 10000, param = "treatment", clustid = c("group_id1", "group_id2"), fe = "Q1_immigration")
  #'boot4 <- boottest(lm_fit, B = 10000, param = "treatment", clustid = c("group_id1", "group_id2"), fe = "Q1_immigration", alpha = 0.2, seed = 8, beta0 = 2)
  #'summary(boot1)
  #'tidy(boot1)
  #'plot(boot1)
