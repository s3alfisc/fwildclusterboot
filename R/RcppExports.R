...
boot_algo3_crv1 <- function(B, G, k, v, scores_mat, scores_boot, tXXinv, Ag, ssc, cores, R) {
    .Call('_fwildclusterboot_boot_algo3_crv1', PACKAGE = 'fwildclusterboot', B, G, k, v, scores_mat, scores_boot, tXXinv, Ag, ssc, cores, R)
}
