...
#' @references Davidson & MacKinnon. "Wild Bootstrap Tests for IV regression" Journal of Economics and Business Statistics (2010) \doi{https://doi.org/10.1198/jbes.2009.07221}
...
mboottest.lm <- function(object,
  ...
  check_arg(teststat_boot, "scalar logical")
