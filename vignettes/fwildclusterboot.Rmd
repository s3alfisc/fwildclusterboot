...
For Rademacher, Normal and Webb weights and `engine = "R"`, you need to set a global seed via `dqrng::dqset.seed()`. For all other options - Mammen weights with `engine = "R"`, `engine = "R-lean"` or `engine = "WildBootTests.jl"`, you can set a global seed via the familiar`set.seed()`. 
