...
For Rademacher, Normal and Webb weights and `boot_algo = "R"`, you need to set a global seed via `dqrng::dqset.seed()`. For all other options - Mammen weights with `boot_algo = "R"`, `boot_algo = "R-lean"` or `boot_algo = "WildBootTests.jl"`, you can set a global seed via the familiar`set.seed()`. 
