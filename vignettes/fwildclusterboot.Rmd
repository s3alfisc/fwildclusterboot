...
# set a Julia seed for reproducibility
fwildclusterboot::set_julia_seed(8785)
boot_lm <- boottest(lm_fit, 
                       clustid = "group_id1", 
                       param = "treatment", 
                       B = 9999, 
...
Through `WildBootTests.jl`, you can also test multiple joint hypotheses via the `waldboottest()` function. 
With minor differences, `waldboottest()'s` syntax largely mirrors `boottest()`.
