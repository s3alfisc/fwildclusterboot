...
#      p-values iter 1 p-values iter 2
# [1,]      0.00140014      0.00140014
# [2,]      0.00210021      0.00210021
# [3,]      0.00110011      0.00110011
# [4,]      0.00100010      0.00100010
```
...
In short, the value `469344150` is used as a seed value in Julia - not `1234` - which is the seed value set in R. But the seed used in Julia is a direct derivative of the R seed and thereby controlled via R's `set.seed()` function.
...
cbind("p-values iter 1" = res[[1]], "p-values iter 2" = res[[2]])
#      p-values iter 1 p-values iter 2
# [1,]      0.00060006      0.00080008
# [2,]      0.00280028      0.00280028
# [3,]      0.00040004      0.00040004
# [4,]      0.00070007      0.00120012
```
...
cbind("p-values iter 1" = res[[1]], "p-values iter 2" = res[[2]])
#      p-values iter 1 p-values iter 2
# [1,]      0.00110011      0.00110011
# [2,]      0.00110011      0.00070007
```
